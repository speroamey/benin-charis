...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="widget">
                    <a href="url('/')"><img alt="" class="img-fluid mb1" src="{{asset('images/logo.png')}}" width="150">
                    </a>
                    <address class="s1">
                ...
                <div class="widget">
                    ...
                    <form action="blank.php" class="row" id="form_subscribe" method="post"
                        ...
                        <div class="col text-center">
                            <input class="form-control" id="name_1" name="name_1" placeholder="entrer votre courriel"
                                type="text" />
